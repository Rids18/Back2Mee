...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO lost_items (user_id, item_name, description, lost_date, location, qr_code) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("isssss", $user_id, $item_name, $description, $lost_date, $location, $qr_code_path);
...
<body class="bg-gray-900 text-gray-200">
    <div class="max-w-lg mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
        ...
        <form action="report_lost1.php" method="POST" enctype="multipart/form-data">
            ...
            <label class="block text-gray-400 mb-2">Upload QR Code (PNG, JPG, JPEG)</label>
            <input type="file" name="qr_code" accept=".png, .jpg, .jpeg" required class="w-full p-2 border rounded mb-4 bg-gray-700 text-white">
